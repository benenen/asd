//! SSH transport for remote hosts (spec §2/M2), via the pure-Rust `russh`
//! client — no subprocess, so the crate keeps its "no PTY/process management"
//! contract and stays viable on Windows.
//!
