...
const CONFIG_NAMES: &[(&str, KeyAction)] = &[
    ...
    ("review", KeyAction::Review),
    ("toggle_files", KeyAction::ToggleFiles),
...
impl Default for KeymapSpec {
    fn default() -> Self {
        ...
        .chain([
            ...
            Binding::fixed(patterns(&["v"]), KeyAction::Review, "review"),
            Binding::fixed(patterns(&["f"]), KeyAction::ToggleFiles, "files"),
